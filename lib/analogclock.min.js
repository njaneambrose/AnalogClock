...
(function ($) {
    var AnalogClock = function (element, options) {
        var settings = $.extend({}, $.fn.analogClock.defaults, options); /*Getting the selected element*/
        var watchouter = $(element);
        watchouter.addClass("analog-clock");
        watchouter.css("position", "relative"); /* Appending watches*/
        ...
        var hour_h = watchouter.find(".hour-hand"); /* Watch effects library*/
